        ...
        <div class="col-12">
            ...
            <div class="register-form text-right">
                <form action="{{ route('company.update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>وصف</label>
                        <textarea name="description" class="form-control" rows="6">{{ $company->description ?? '' }}</textarea>
                    </div>
                    <div class="form-group">
                        <label>صورة</label>
                        <input type="file" class="form-control" name="image" title="لم تقم باختيار ملف">
                    </div>
